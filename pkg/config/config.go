...
type Config struct {
	...
	BotDBFile string `mapstructure:"db_file"`
...
func unmarshal(cfg *Config) error {
	...
	if err := viper.UnmarshalKey("message.response", &cfg.Massages.Responses); err != nil {
		return err
	}

	if err := viper.UnmarshalKey("messaage.error", &cfg.Massages.Errors); err != nil {
		return err
	}
	return nil
}
...
func fromEnv(cfg *Config) error {
	...
	cfg.PocketConsumerKey = viper.GetString("cunsummer_key")
